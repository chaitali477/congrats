...
function MessageCard({ isActive }) {
  ...
  const message = `[Cutiee 💖],

So proud of you 🥹💙

As you begin your training, remember this you are capable, talented, and deserving of every opportunity that comes your way 🌟
No matter where life takes you, I’ll always be proud of you and silently cheering for you from my heart 💌
Congratulations on this beautiful beginning 🎉
Always proud of you!

— [Someone who truly believes in you 💖]`;
